...
import { formatarData, formatarDataBanco, formatarDia} from '../conversoes';
function ModalEditar({setMostrarModalEditar, handleEditTransaction, transaction, id}){
    const [date, setDate] = useState(formatarData(transaction.date));
    ...
    async function handleSubmit(){
      try {
        ...
        await handleEditTransaction(body, id);
      } catch (error) {
        console.log(error);
      }
    }
